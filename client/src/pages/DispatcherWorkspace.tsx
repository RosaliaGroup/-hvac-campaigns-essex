/**
 * Dispatcher Workspace (M1) — admin-only, READ-ONLY, single-day.
 *
 ...
 * assignment, rescheduling, and drag-and-drop arrive in M3. Server enforcement
  ...
  if (!allowed) {
    return (
      <div className="mx-auto max-w-2xl p-8">
        ...
        <p className="mt-2 text-muted-foreground">This workspace is available to administrators only.</p>
      </div>
    );
  }
