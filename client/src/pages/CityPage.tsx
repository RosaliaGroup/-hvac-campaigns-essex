...
const CITY_CONTENT: Record<string, { county: string; intro: string; details: string }> = {
  ...
  hawthorne: {
    ...
    details: "Hawthorne’s housing stock, including early 20th-century detached homes and mid-century developments, requires HVAC systems suited for both traditional and modern energy efficiency standards. Residents can benefit from New Jersey state rebates offering up to $16,000 for eligible HVAC upgrades. The borough’s varied housing density and seasonal climate necessitate reliable heating and cooling solutions. Mechanical Enterprise LLC offers services tailored to the area's specific needs, including maintenance and installation of energy-efficient systems compatible with PSE&G and JCP&L infrastructure. This ensures compliance with local codes and optimizes HVAC performance across neighborhoods like Prospect Park and along Diamond Bridge Avenue.",
  },
  hillside: {
    county: "Essex County",
  ...
  kearny: {
    ...
    details: "Kearny's housing stock includes a variety of types, from single-family homes in neighborhoods like Arlington to more densely packed row houses near the Kearny Riverbank and residential areas along Bergen Avenue. Many homes in the area require efficient heating and cooling solutions to manage seasonal temperature fluctuations. Residents can benefit from New Jersey's incentive programs offering rebates up to $16,000 for qualifying HVAC upgrades. Mechanical Enterprise LLC provides HVAC services tailored to the specific needs of Kearny's homes, ensuring compliance with local codes and utility provider requirements. The company's experience with PSE&G's service area supports proper installation and maintenance of energy-efficient systems suited for Kearny's climate and housing types.",
  },
  linden: {
    county: "Union County",
  ...
  springfield: {
    ...
    details: "Springfield's mix of colonial-style single-family residences and mid-20th century homes requires HVAC systems that accommodate varying insulation and space needs. Residents benefit from PSE&G's energy programs, which align with state incentives offering rebates up to $16,000 for energy-efficient upgrades. Mechanical Enterprise LLC provides HVAC services tailored to the township’s diverse housing stock, including systems designed for efficient heating and cooling in the temperate climate typical of Union County. The township's geography, with its mix of residential streets like Mountain Avenue and proximity to urban centers, necessitates reliable HVAC solutions that meet both comfort and energy efficiency standards.",
  },
  sussex: {
    county: "Sussex County",
...
const SERVICES = [
  { icon: "🌡️", title: "Heat Pump Installation", desc: "High-efficiency heat pump systems fully eligible for NJ rebates up to $16,000.", href: `${BASE}/residential` },
...
export default function CityPage({ city, slug }: CityPageProps) {
  useSEO({
    ...
    description: `HVAC installation in ${city} NJ. Free assessment, NJ rebates up to $16,000. Licensed NJ contractor. Call ${PHONE}.`,
  ...
  const faqs = [
    { q: `How much does heat pump installation cost in ${city}, NJ?`, a: `Installation costs vary by system size and home. However, with NJ rebates up to $16,000, many ${city} homeowners significantly reduce their out-of-pocket cost. Book a free assessment to get your exact numbers.` },
    { q: `What rebates are available for ${city}, NJ homeowners in 2026?`, a: `${city} homeowners may qualify for NJ rebates up to $16,000. Eligibility depends on your equipment and property. We assess your exact eligibility for free.` },
        ...
        <div className="container">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-[#0a1628] mb-3">
              2026 Rebate Program — {city}, NJ Homeowners
            </h2>
            <p className="text-gray-600 mb-8">A program that can offset your installation cost:</p>
